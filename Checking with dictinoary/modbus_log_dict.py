...
command_select_for_journal = {
								...
								2:"journalctl -r | grep 'unknown modbus InputRegister ' -m 1",
								3:"journalctl -r | grep 'unknown modbus InputRegisters ' -m 1",
...
def get_command_to_run(logger,fsm_targets,current_time,command_id):
